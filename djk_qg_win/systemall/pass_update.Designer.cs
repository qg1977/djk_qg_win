namespace djk_qg_win.systemall
{
    partial class pass_update
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.text_old_pass_label = new djk_qg_win.a_qg_trol.qg_label();
            this.text_old_pass = new djk_qg_win.a_qg_trol.qg_text_pass();
            this.qg_label2 = new djk_qg_win.a_qg_trol.qg_label();
            this.text_old_name = new djk_qg_win.a_qg_trol.qg_read_text();
            this.qg_label1 = new djk_qg_win.a_qg_trol.qg_label();
            this.qg_bt_label1 = new djk_qg_win.a_qg_trol.qg_bt_label();
            this.panel2 = new System.Windows.Forms.Panel();
            this.text_new_pass_2_label = new djk_qg_win.a_qg_trol.qg_label();
            this.text_new_pass_label = new djk_qg_win.a_qg_trol.qg_label();
            this.text_new_name_label = new djk_qg_win.a_qg_trol.qg_label();
            this.text_new_name = new djk_qg_win.a_qg_trol.qg_text();
            this.text_new_pass_2 = new djk_qg_win.a_qg_trol.qg_text_pass();
            this.qg_label5 = new djk_qg_win.a_qg_trol.qg_label();
            this.text_new_pass = new djk_qg_win.a_qg_trol.qg_text_pass();
